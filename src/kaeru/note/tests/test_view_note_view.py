...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_note_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='note-view'
        )
        self.assertTrue(view.__name__ == 'note-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in note-view'
        # )

    def test_note_view_not_matching_interface(self):
